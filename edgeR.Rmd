---
title: "Guide for Differential Expression Analysis using edgeR"
...
# Find the differentially expressed genes between metastasis-normal vs primary-normal
#
...
write.csv(as.data.frame(res), file = "edgeR_Mets_vs_Prims_(byNorm)_FDR.csv")
```

### 4. Plots
```{r, echo=FALSE}
deGenes <- decideTestsDGE(ds.lrt, p=0.05, adjust.method = "BH", lfc = 0)
deGenes <- rownames(ds.lrt)[as.logical(deGenes)]
...
# More plots available in my previous guide: https://github.com/SimonLab-RU/DEseq2
```
